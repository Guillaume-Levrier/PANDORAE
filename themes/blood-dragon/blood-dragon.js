...
const sun = () => {
    ...
    svg.attr("id","sun");
    svg.attr("class","purgeable");
    svg.attr("width", window.innerWidth).attr("height", window.innerHeight);          // Attributing width and height to svg
    svg.style("position","absolute");
    svg.style("z-index","2");
    svg.style("top","0px");
    document.getElementById('sun').style.animation = "flicker var(--animation-time) ease alternate infinite";
