  ...
  var simulation = d3
    ...
    .force(
      ...
      d3
        ...
        .x((d) => d3.pointRadial(x(d.date), y(d.zone - clustersNest.size))[0])
    )
    .force(
      "y",
      d3
        .forceY()
        .strength(0.1) // nodes are attracted to their X origin
        .y((d) => d3.pointRadial(x(d.date), y(d.zone - clustersNest.size))[1])
    );
      ...
      switch (_resize) {
        case "e":
          ...
          if (
            ...
            clampedAngle =
              _originalBrushData.startAngle + (_current - _start) - Math.PI * 2;
          } else if (
            _originalBrushData.startAngle + (_current - _start) <
        ...
        case "w":
          ...
          if (
            ...
            clampedAngle =
              _originalBrushData.endAngle + (_current - _start) + Math.PI * 2;
          } else if (
            _originalBrushData.endAngle + (_current - _start) >
