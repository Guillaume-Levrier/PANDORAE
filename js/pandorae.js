...
const loadTheme = (themeName) => {
  ...
  var themeData = [
    ...
    },
    {
      ...
      "fullscreenable": true,
      "theme-author": "GL",
      "theme-type": "svg-canvas",
      "menu-icon": {
        "background-color": "rgba(0,0,0,0.2)",
        "color": "#66ffff",
        "text-shadow": ".5px .5px 0px #ff33cc",
      ...
      "theme-background": null,
      "theme-mask": "themes/blood-dragon/fuji.svg",
      "screenMachine": { "display": "none" },
      "coreCanvas": {
        "position": "absolute",
        "display": "none",
      ...
      "field": {
        ...
        "pointer-events": "all",
        "color": "#ff33cc",
        "text-shadow": "1.5px 1.5px 0px #66ffff",
        "font-family": "'Noto Sans', 'Noto Sans SC', sans-serif",
        "letter-spacing": "0.15em",
        "font-variant": "small-caps",
        "font-size": "2.6em",
      ...
      "console": {
        ...
        "background-image": "linear-gradient(to right, rgba(0,0,0,0),rgba(0,0,0,0)70%, rgba(0,0,0,0.6))",
        "color": "#66ffff",
        "text-shadow": ".5px .5px 0px #ff33cc",
        "width" : "100%",
        "height" : "100%",
