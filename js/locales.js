  ...
  EN: {
    ...
    tutorial: {
      sections: {
        ...
        slide4:
          "<div style='text-align:center'><span class='title'>PANDORÆ  allows you to perform three main kinds of operations :</span><br><br><a data-action=\"scroll'('Chapter1')\">Load & enrich data</a><br><br><a data-action=\"scroll'('Chapter2')\">Explore data</a><br><br><i class='material-icons'><a class='arrowDown' data-action='scroll' data-target='Chapter1'>arrow_downward</a></i></div>",
        Chapter1:
