const CMT = {"EN":{
    ...
    "tutorial":{
        "sections":{
            "mainTitle":"<div class='title' style='font-size:36px;font-weight: bold;'>Welcome to PANDORÆ</div><br><i class='material-icons arrowDown'><a class='arrowDown' onclick='smoothScrollTo(\"slide2\")'>arrow_downward</a></i>",
            "slide2":"<span class='title'>This short tutorial will show you some of the things PANDORÆ can do.</span><br><br><i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"slide2bis\")'>arrow_downward</a></i>",
            "slide2bis":"<span class='title'>As you noticed, you can click on the <strong>arrows</strong> to go down or back.</span><br><br>You can also use your <strong>mouse wheel</strong> to navigate up and down.&nbsp;<br><br>            You can skip specific chapters and come back to this <strong>tutorial</strong> later.<br><br>            If you're unsure of how to proceed, you can watch the step-by-step video of this tutorial while you interact with it.<br><br><i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"slide3\")'>arrow_downward</a></i>",
            "slide3":"<span class='title'>PANDORÆ is a <strong>data retrieval & exploration tool.</strong></span><br><br>You can use it for many purposes, like building a <strong>literature review</strong>.<br><br><i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"slide4\")'>arrow_downward</a></i>",
            "slide4":"<span class='title'>PANDORÆ  allows you to perform three main kinds of operations :</span><br><br><a onclick=\"smoothScrollTo('Chapter1')\">Load & enrich data</a><br><br><a onclick=\"smoothScrollTo('Chapter2')\">Explore data</a><br><br><i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"Chapter1\")'>arrow_downward</a></i>",
            "Chapter1":"<span class='title'><strong>Chapter 1: Loading & enriching data</strong></span><br><br>PANDORÆ enables you to load data from different types of sources.<br><br>Those sources can be online databases that aggregate documents such as scientific articles.<br> <br>But you can really add <strong>any kind of document</strong>. Those can be related or unrelated to science articles.<br><br>PANDORÆ also supports other types of data, such as those extracted from social-media or clinical trials.<br>&nbsp;<br><div class='arrowDown'><i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"Cascade\")'>arrow_downward</a></i></div>",
            "Cascade":"<span class='title'><strong>Cascade: Available data flows</strong></span><br><br><div style='display: inline-flex'><div style='flex:auto'>   <strong>Cascade</strong> is how <a onclick='smoothScrollTo(\"flux\")'>Flux</a> displays its data flows. As you can see, the data flows from you to the system. Hovering a process shows to which other process it is linked.  <br>&nbsp;<br> Cascade behaves like menu: click on a process and its options will be displayed.<br>&nbsp;<br> <br>&nbsp;<br> <div class='arrowDown'><i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"flux\")'>arrow_downward</a></i></div></div><div style='flex:auto'><svg></svg></div></div><br>&nbsp;<br>",
            "flux":"<span class='title'><strong>Using Flux</strong></span><br><br>Loading data happens in the <strong>Flux</strong> tab of PANDORÆ's menu.<br><br>Click <a onclick='tuto(\"flux');'>here</a> to learn how to open Flux.<br>&nbsp;<br><div class='arrowDown'><i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"flux2\")'>arrow_downward</a></i></div>",
            ...
            "FinalChap":"<span class='title'><strong>Final Chapter: the great escape</strong></span><br>      Our short journey together is about to come to an end.<br>&nbsp;<br>       It is now time for you to learn how to escape the Tutorial's constraint.       <br>&nbsp;<br>      Time to break free.      <br>&nbsp;<br><div class='arrowDown'>    <i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"final2\")'>arrow_downward</a></i></div>",
            "final2":"<span class='title'><strong>USER wants to break free</strong></span><br>        You might have noticed when you first started PANDORÆ that your possibilities were limited. <br>&nbsp;<br>        The <i  class='material-icons'>menu</i> <strong>menu</strong> button was 'forbidden', the <i  class='material-icons'>code</i> <strong>console</strong>  button too. <br>&nbsp;<br>        Your only option was to start the tutorial. Let's change that.        <br>&nbsp;<br>  <div class='arrowDown'>    <i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"final3\")'>arrow_downward</a></i></div>",
            "final3":"<span class='title'><strong>Back to Flux-ture</strong></span><br>          PANDORÆ starts in tutorial mode when it detects that no user name has been entered. <br>&nbsp;<br>          To turn off the tutorial mode, go back to <a onclick='smoothScrollTo(\"flux\")'>Flux</a> and enter a user name. <br>&nbsp;<br>          Then come back here.<br>&nbsp;<br>    <div class='arrowDown'>    <i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"final4\")'>arrow_downward</a></i></div>",
            "final4":"<span class='title'><strong>The main field</strong></span><br>            PANDORÆ communicates with you by displaying messages in the main field, on the main screen. You can also write in this field to communicate with PANDORÆ. <br>&nbsp;<br>            To select the field, push your <strong>TAB</strong> key after clicking on the main screen. You can then enter commands and push the <strong>ENTER</strong> key. <br>&nbsp;<br>      <div class='arrowDown'>    <i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"final5\")'>arrow_downward</a></i></div>",
            "final5":"<span class='title'><strong>Entering commands</strong></span><br>             If your menu is locked, you can use the &nbsp;<span class='commands'>unlock menu</span>&nbsp; command. <br>&nbsp;<br>             It also works in the console.             <br>&nbsp;<br>             You can also change PANDORÆ's theme with the &nbsp;<span class='commands'>change theme</span>&nbsp; command. <br>&nbsp;<br>             Try with &nbsp;<span class='commands'>change theme blood-dragon</span>&nbsp; for example. You can switch back with &nbsp;<span class='commands'>change theme normal</span>. <br>&nbsp;<br>                <div class='arrowDown'>    <i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"final6\")'>arrow_downward</a></i></div>",
            "final6":"<span class='title'><strong>Call me ...  maybe?</strong></span><br>            If you ever miss the tutorial, or want to check one of its chapter, you can use the             &nbsp;<span class='commands'>start tutorial</span>&nbsp; command.<br>&nbsp;<br> You will always be welcome here.<br>&nbsp;<br>                <div class='arrowDown'>    <i class='material-icons'><a class='arrowDown' onclick='smoothScrollTo(\"final7\")'>arrow_downward</a></i></div>",
            "final7":"<span class='title'><strong>Freedom at last</strong></span><br>           You will learn how to use PANDORÆ mostly by trial and error.<br>&nbsp;<br> If you're a researcher and/or developer, you might want to go have a look at its            <a onclick='shell.openExternal(\"https://github.com/Guillaume-Levrier/PANDORAE\")'>source code</a>.<br>&nbsp;<br>           A wiki of the project is available <a onclick='shell.openExternal(\"https://github.com/Guillaume-Levrier/PANDORAE/wiki\")'>here</a>.           <br>&nbsp;<br>           <div class='arrowDown'>    <i class='material-icons'><a class='arrowDown' onclick='lastScroll()'>arrow_downward</a></i></div>",
            "final8":"This <strong>CORE</strong> is now yours. <br>&nbsp;<br>           Close the software and restart it to escape the tutorial.<br>&nbsp;<br>           Thank you for using PANDORÆ.<br><br>                    <div id='restartCount' style='font-weight: bolder'></div>",
        }
